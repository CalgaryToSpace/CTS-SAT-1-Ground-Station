# CTS-SAT-1-Ground-Support Software (`cts1_telecommand_input`)
...
3. Run `cts1_telecommand_input --help` to ensure it installed.
4. Run `cts1_telecommand_input` to start the ground support terminal.
...
6. Run `cts1_telecommand_input --help` to ensure it installed.
7. Run `cts1_telecommand_input` to start the ground support terminal.
...
After following the Getting Started section, you can run the ground support terminal by running `cts1_telecommand_input`.
...
cts1_telecommand_input -r ../CTS-SAT-1-OBC-Firmware
```
...
3. Optional: Run `cts1_telecommand_input --debug` to start the ground support terminal in debug mode.
